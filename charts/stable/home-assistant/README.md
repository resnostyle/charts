...
helm repo update
helm install home-assistant bjw-s/home-assistant
```
...
helm install home-assistant \
  --set env.TZ="America/New York" \
    bjw-s/home-assistant
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install home-assistant bjw-s/home-assistant -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/home-assistant?modal=changelog)
