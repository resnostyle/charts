...
* <https://github.com/bjw-s/charts/tree/master/charts/teedy>
...
helm repo update
helm install teedy bjw-s/teedy
```
...
```console
helm install teedy bjw-s/teedy -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/teedy?modal=changelog)
