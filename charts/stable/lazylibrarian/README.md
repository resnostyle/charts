...
helm repo update
helm install lazylibrarian bjw-s/lazylibrarian
```
...
```console
helm install lazylibrarian bjw-s/lazylibrarian -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/lazylibrarian?modal=changelog)
