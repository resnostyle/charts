...
* <https://github.com/bjw-s/charts/tree/master/charts/stable/plex>
...
```console
helm install plex bjw-s/plex -f values.yaml
```
...
| image.repository | string | `"ghcr.io/bjw-s/plex"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/plex?modal=changelog)
