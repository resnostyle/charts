...
helm repo update
helm install games-on-whales bjw-s/games-on-whales
```
...
helm install games-on-whales \
  --set env.TZ="America/New York" \
    bjw-s/games-on-whales
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install games-on-whales bjw-s/games-on-whales -f values.yaml
```
...
It does not require any custom settings but if you use [intel-gpu-plugin](https://github.com/bjw-s/charts/tree/master/charts/stable/intel-gpu-plugin)
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/games-on-whales?modal=changelog)
