...
* <https://github.com/bjw-s/charts/tree/master/charts/librespeed>
...
helm repo update
helm install librespeed bjw-s/librespeed
```
...
```console
helm install librespeed bjw-s/librespeed -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/librespeed?modal=changelog)
