...
helm repo update
helm install vikunja bjw-s/vikunja
```
...
```console
helm install vikunja bjw-s/vikunja -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/vikunja?modal=changelog)
