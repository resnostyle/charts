...
helm repo update
helm install anonaddy bjw-s/anonaddy
```
...
```console
helm install anonaddy bjw-s/anonaddy -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/anonaddy?modal=changelog)
