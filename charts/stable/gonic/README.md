...
helm repo update
helm install gonic bjw-s/gonic
```
...
```console
helm install gonic bjw-s/gonic -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/gonic?modal=changelog)
