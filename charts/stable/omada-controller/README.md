...
* <https://github.com/bjw-s/charts/tree/master/charts/omada-controller>
...
helm repo update
helm install omada-controller bjw-s/omada-controller
```
...
helm install omada-controller \
  --set env.TZ="America/New York" \
    bjw-s/omada-controller
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install omada-controller bjw-s/omada-controller -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/omada-controller?modal=changelog)
