...
* <https://github.com/bjw-s/charts/tree/master/charts/node-red>
...
helm repo update
helm install node-red bjw-s/node-red
```
...
```console
helm install node-red bjw-s/node-red -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/node-red?modal=changelog)
