...
helm repo update
helm install owncloud-ocis bjw-s/owncloud-ocis
```
...
```console
helm install owncloud-ocis bjw-s/owncloud-ocis -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/owncloud-ocis?modal=changelog)
