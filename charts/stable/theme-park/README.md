...
* <https://github.com/bjw-s/container-images/tree/main/apps/theme-park>
...
helm repo update
helm install theme-park bjw-s/theme-park
```
...
```console
helm install theme-park bjw-s/theme-park -f values.yaml
```
...
| image.repository | string | `"ghcr.io/bjw-s/theme-park"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/theme-park?modal=changelog)
