...
* <https://github.com/bjw-s/charts/tree/master/charts/uptimerobot-prometheus>
...
helm repo update
helm install uptimerobot-prometheus bjw-s/uptimerobot-prometheus
```
...
helm install uptimerobot-prometheus \
  --set env.TZ="America/New York" \
    bjw-s/uptimerobot-prometheus
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install uptimerobot-prometheus bjw-s/uptimerobot-prometheus -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/uptimerobot-prometheus?modal=changelog)
