...
helm repo update
helm install openemr bjw-s/openemr
```
...
```console
helm install openemr bjw-s/openemr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/openemr?modal=changelog)
