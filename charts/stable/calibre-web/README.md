...
helm repo update
helm install calibre-web bjw-s/calibre-web
```
...
```console
helm install calibre-web bjw-s/calibre-web -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/calibre-web?modal=changelog)
