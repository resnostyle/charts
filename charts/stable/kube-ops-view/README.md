...
helm repo update
helm install kube-ops-view bjw-s/kube-ops-view
```
...
```console
helm install kube-ops-view bjw-s/kube-ops-view -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/kube-ops-view?modal=changelog)
