...
helm repo update
helm install ihatemoney bjw-s/ihatemoney
```
...
```console
helm install ihatemoney bjw-s/ihatemoney -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/ihatemoney?modal=changelog)
