...
* <https://github.com/bjw-s/SB6183-stats-for-influxdb>
...
helm repo update
helm install modem-stats bjw-s/modem-stats
```
...
```console
helm install modem-stats bjw-s/modem-stats -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/modem-stats?modal=changelog)
