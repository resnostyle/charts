...
helm repo update
helm install foundryvtt bjw-s/foundryvtt
```
...
```console
helm install foundryvtt bjw-s/foundryvtt -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/foundryvtt?modal=changelog)
