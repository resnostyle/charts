...
```console
helm install ntfy bjw-s/ntfy -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/ntfy?modal=changelog)
