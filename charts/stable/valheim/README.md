...
helm repo update
helm install valheim bjw-s/valheim
```
...
```console
helm install valheim bjw-s/valheim -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/valheim?modal=changelog)
