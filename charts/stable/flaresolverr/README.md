...
helm repo update
helm install flaresolverr bjw-s/flaresolverr
```
...
```console
helm install flaresolverr bjw-s/flaresolverr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/flaresolverr?modal=changelog)
