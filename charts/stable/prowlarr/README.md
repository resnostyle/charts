...
![Version: 1.5.0](https://img.shields.io/badge/Version-1.5.0-informational?style=flat-square) ![AppVersion: v0.3.0.1710](https://img.shields.io/badge/AppVersion-v0.3.0.1710-informational?style=flat-square)
...
helm repo update
helm install prowlarr bjw-s/prowlarr
```
...
```console
helm install prowlarr bjw-s/prowlarr -f values.yaml
```
...
| image.repository | string | `"ghcr.io/bjw-s/prowlarr"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/prowlarr?modal=changelog)
