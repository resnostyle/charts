...
helm repo update
helm install lychee bjw-s/lychee
```
...
```console
helm install lychee bjw-s/lychee -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/lychee?modal=changelog)
