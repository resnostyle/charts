...
* <https://github.com/bjw-s/container-images/tree/main/apps/emby>
...
```console
helm install emby bjw-s/emby -f values.yaml
```
...
| image.repository | string | `"ghcr.io/bjw-s/emby"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/emby?modal=changelog)
