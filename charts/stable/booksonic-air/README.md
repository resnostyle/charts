...
helm repo update
helm install booksonic-air bjw-s/booksonic-air
```
...
```console
helm install booksonic-air bjw-s/booksonic-air -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/booksonic-air?modal=changelog)
