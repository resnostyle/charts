...
helm repo update
helm install organizr bjw-s/organizr
```
...
```console
helm install organizr bjw-s/organizr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/organizr?modal=changelog)
