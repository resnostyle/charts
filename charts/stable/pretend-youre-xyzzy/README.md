...
helm repo update
helm install pretend-youre-xyzzy bjw-s/pretend-youre-xyzzy
```
...
helm install pretend-youre-xyzzy \
  --set env.TZ="America/New York" \
    bjw-s/pretend-youre-xyzzy
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install pretend-youre-xyzzy bjw-s/pretend-youre-xyzzy -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/pretend-youre-xyzzy?modal=changelog)
