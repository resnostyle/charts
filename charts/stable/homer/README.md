...
helm repo update
helm install homer bjw-s/homer
```
...
```console
helm install homer bjw-s/homer -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/homer?modal=changelog)
