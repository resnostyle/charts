...
helm repo update
helm install grocy bjw-s/grocy
```
...
```console
helm install grocy bjw-s/grocy -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/grocy?modal=changelog)
