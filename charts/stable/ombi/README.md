...
```console
helm install ombi bjw-s/ombi -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/ombi?modal=changelog)
