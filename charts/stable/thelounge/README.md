...
helm repo update
helm install thelounge bjw-s/thelounge
```
...
```console
helm install thelounge bjw-s/thelounge -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/thelounge?modal=changelog)
