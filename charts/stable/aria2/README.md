...
helm repo update
helm install aria2 bjw-s/aria2
```
...
```console
helm install aria2 bjw-s/aria2 -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/aria2?modal=changelog)
