...
* <https://github.com/bjw-s/charts/tree/master/charts/youtubedl-material>
...
helm repo update
helm install youtubedl-material bjw-s/youtubedl-material
```
...
helm install youtubedl-material \
  --set env.TZ="America/New York" \
    bjw-s/youtubedl-material
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install youtubedl-material bjw-s/youtubedl-material -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/youtubedl-material?modal=changelog)
