...
helm repo update
helm install webtrees bjw-s/webtrees
```
...
```console
helm install webtrees bjw-s/webtrees -f values.yaml
```
...
| env.BASE_URL | string | `"https://webtrees.bjw-s.com"` | Base URL of the installation, with protocol. This needs to be in the form of http://webtrees.example.com |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/webtrees?modal=changelog)
