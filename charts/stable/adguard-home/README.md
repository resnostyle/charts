...
helm repo update
helm install adguard-home bjw-s/adguard-home
```
...
```console
helm install adguard-home bjw-s/adguard-home -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/adguard-home?modal=changelog)
