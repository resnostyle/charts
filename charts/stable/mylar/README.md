...
* <https://github.com/bjw-s/charts/tree/master/charts/mylar>
...
helm repo update
helm install mylar bjw-s/mylar
```
...
```console
helm install mylar bjw-s/mylar -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/mylar?modal=changelog)
