...
helm repo update
helm install uptime-kuma bjw-s/uptime-kuma
```
...
```console
helm install uptime-kuma bjw-s/uptime-kuma -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/uptime-kuma?modal=changelog)
