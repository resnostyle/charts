...
helm repo update
helm install dizquetv bjw-s/dizquetv
```
...
```console
helm install dizquetv bjw-s/dizquetv -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/dizquetv?modal=changelog)
