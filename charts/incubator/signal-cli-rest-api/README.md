...
helm repo update
helm install signal-cli-rest-api bjw-s/signal-cli-rest-api
```
...
helm install signal-cli-rest-api \
  --set env.TZ="America/New York" \
    bjw-s/signal-cli-rest-api
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install signal-cli-rest-api bjw-s/signal-cli-rest-api -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/bjw-s/signal-cli-rest-api?modal=changelog)
